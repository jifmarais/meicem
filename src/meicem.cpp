...
ComplexMatrix fillZmatrixTriangleInefficient(const TriangleContainer& tContainer, double freq)
{
...
//    ComplexMatrix Vvector {(unsigned)eContainer.size(), 1};
    ...
    ComplexMatrix Zmatrix = fillZmatrixTriangleInefficient(tContainer, freq);

    Zmatrix.print();
//    (Zmatrix.inverse()*Zmatrix).print();
//    (Zmatrix.inverse()*Vvector).print();
