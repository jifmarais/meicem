...
-- Save project
app:SaveAs([[test2_4triangles.cfx]])
...
project.Exporter.Mesh:ExportParts("test2_4triangles.nas",geometryTargets,{})
...
Union1 = project.Geometry["Union1"]
geometryTargets = { Union1 }
project.Exporter.Mesh:ExportParts("test2_4triangles_rotate.nas",geometryTargets,{})
